...
async function callClaude(prompt) {
  const isArtifact = window.location.hostname === "null" || window.location.hostname === "";
  ...
  if (res.status === 429) {
    throw new Error(data.error || "Hourly evaluation limit reached. Please try again later.");
  }
  if (!res.ok) {
